...
import { useDeleteAdminUserUseCaseContext } from "@/src/adapters/infrastructure/di/use_cases/admin/delete_admin_user.use_case.context";
...
const useAdminUserDelete = () => {
  ...
  const { deleteAdminUsersUseCase } = useDeleteAdminUserUseCaseContext();
